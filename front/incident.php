...
echo "<div class='d-flex align-items-center gap-2'><a href='index.php' class='btn btn-sm btn-outline-secondary'><i class='ti ti-arrow-left'></i></a><h2 class='m-0'>Gestão de Incidentes</h2></div>";
